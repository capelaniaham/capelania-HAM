...
const ChaplainCard: React.FC<ChaplainCardProps> = ({ stat }) => {
  // A lógica agora foca apenas nos dados de Manaus (stats) fornecidos pelo Reports.tsx
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex gap-2 mt-1">
            <span className="text-[8px] font-black uppercase bg-blue-50 text-blue-600 px-2 py-0.5 rounded-md">Alunos HAM: {data.students}</span>
      ...
      <div className="flex flex-col gap-3">
        <div className="rounded-2xl p-5 bg-blue-50 border border-slate-100/50">
          <div className="flex justify-between items-center mb-4 pb-2 border-b border-black/5">
            <span className="text-[10px] font-black uppercase tracking-widest text-blue-700">Consolidado HAM</span>
